...
global.owner = process.env.OWNER_NUMBER  || '94727641346' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=7EkR2bbD#Y2MCO8BRV0Dapoa4QafS9cfoeTmP_sNyGQnFmal8M04' ,
